...
exports.createSkeletalNodes = exports.SkeletalNode = exports.Node = void 0;
...
class Node {
    constructor() {
        ...
        this.inverseWorldScale = gl_matrix_1.vec3.create();
...
class SkeletalNode {
    ...
    recalculateTransformation(scene) {
        ...
        gl_matrix_1.mat4.fromRotationTranslationScaleOrigin(localMatrix, computedRotation, this.localLocation, computedScaling, pivot);
        gl_matrix_1.mat4.mul(worldMatrix, parent.worldMatrix, localMatrix);
        gl_matrix_1.quat.mul(worldRotation, parent.worldRotation, computedRotation);
        // Inverse world rotation
        inverseWorldRotation[0] = -worldRotation[0];
