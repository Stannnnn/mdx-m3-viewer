...
class TokenStream {
    ...
    *readBlock() {
    ...
    writeNumberAttrib(name, value) {
        this.writeLine(`${name} ${math_1.floatDecimals(value, this.precision)},`);
    }
    /**
     * Name "Value",
     */
    ...
    writeVectorAttrib(name, value) {
        this.writeLine(`${name} { ${math_1.floatArrayDecimals(value, this.precision)} },`);
    }
    /**
    ...
    writeColor(name, value) {
        let b = math_1.floatDecimals(value[0], this.precision);
        let g = math_1.floatDecimals(value[1], this.precision);
        let r = math_1.floatDecimals(value[2], this.precision);
     ...
     */
    writeVector(value) {
        this.writeLine(`{ ${math_1.floatArrayDecimals(value, this.precision)} },`);
    }
    /**
     * Name Vectors {
     *     { Value1, Value2, ..., ValueSize },
