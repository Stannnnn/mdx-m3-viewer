...
export default class Unit {
    ...
    load(stream: BinaryStream, version: number, subversion: number, isReforged: boolean): void;
    save(stream: BinaryStream, version: number, subversion: number, isReforged: boolean): void;
    getByteLength(version: number, subversion: number, isReforged: boolean): number;
}
